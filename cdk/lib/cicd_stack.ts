...
export class CICDStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props: CicdStackProps) {
    ...
    codebuildRole.addToPolicy(
      new iam.PolicyStatement({ resources: ["*"], actions: ["ecr:*"] })
    );
    
    // Django codebuild project
    const djangoCodebuildProject = new codebuild.Project(
      this,
      id + "django-build-project",
      {
    ...
    const djangoManualApprovalAction =
